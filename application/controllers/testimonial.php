...
class Testimonial extends CI_Controller {
	...
	function cari()
	{
		...
		$data['judul'] = "Testimonial Pelanggan - An-nas Via Production";
		...
		$data['testi'] = $this->songkok_model->tampil_testimonial($limit,$offset);
	...
	{
		$data['menu'] = $this->songkok_model->menu_kategori('0','0');
		$data['judul'] = "Testimonial Pengunjung - An-nas Via Production";
		$data['slide_atas'] = $this->songkok_model->tampil_slide_produk(10);
		$data['slide_laris'] = $this->songkok_model->tampil_slide_produk_terlaris_kiri(2);
		$data['slide_rekomendasi'] = $this->songkok_model->tampil_slide_produk(6);
		$data['testimonial'] = $this->songkok_model->tampil_testimonial(10,0);
	...
	function baca()
	{
		...
		$data['slide_rekomendasi'] = $this->songkok_model->tampil_slide_produk(6);
		$data['testimonial'] = $this->songkok_model->tampil_testimonial(10,0);
		$data['det'] = $this->songkok_model->tampil_detail_testimonial($kode);
	...
	function kirim_pesan()
	{
		...
		else
		{
			...
			else
			{
				...
				$this->songkok_model->simpan_testimonial($datapesan);
				?>
				<script>
