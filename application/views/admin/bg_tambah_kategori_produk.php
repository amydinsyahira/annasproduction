...
<form method="post" class="validateJS"  action="<?php echo base_url(); ?>aksesroot/insert_kategori">
<table width="100%">
	<tr><td width="150">Nama Kategori Produk</td><td>:</td><td><input type="text" name="nama" id="nama" class="login-inp validate[required]" size="60"> </td></tr>
